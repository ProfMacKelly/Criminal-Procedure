...
This page is adapted from [XI. Warrant Exceptions (Part 2)](https://openbooks.lib.msu.edu/cj275/chapter/chimel-v-california-1969/) by [Christoper E. Smith](https://cj.msu.edu/directory/smith-christopher.html), used under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0). This adaptation is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0).
