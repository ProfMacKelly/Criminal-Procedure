...
## _Mills v. City of Overland Park,_ 251 Kan. 434, 837 P.2d 370 (1992)
...
{% hint style="info" %}
<mark style="color:red;">**A court's holding is the ultimate answer to the issue/question.**</mark>
{% endhint %}
...
{% hint style="info" %}
<mark style="color:red;">**The rule (or rules) is the law of the case that the court used as the test (basically, a formula) that forms the basis of its analysis to arrive at the holding.**</mark>
{% endhint %}
