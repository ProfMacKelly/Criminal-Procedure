...
{% stepper %}
{% step %}
### [Primers on Legal Thinking, Reasoning & Analysis](primers-on-legal-thinking-reasoning-and-analysis.md)
{% endstep %}

{% step %}
### [Introduction to Reading & Briefing Cases](introduction-to-reading-and-briefing-cases.md)
{% endstep %}

{% step %}
### [Exercise: Brief the Case](exercise-brief-the-case.md)
{% endstep %}
{% endstepper %}
